...
class AdminCommunicationGeneratorSpec extends Specification {
    ...
    def "generates CommunicationController in communication package"() {
        ...
        then:
        Files.exists(srcMainJava.resolve("com/fractalx/admin/communication/CommunicationController.java"))
    }

    def "CommunicationController is in com.fractalx.admin.communication package"() {
        when:
        generator.generate(srcMainJava, BASE, [order])

        then:
        controller().contains("package com.fractalx.admin.communication")
    }
    ...
    def "CommunicationController imports ServiceMetaRegistry"() {
        ...
        then:
        controller().contains("ServiceMetaRegistry") || controller().contains("com.fractalx.admin.services")
    }
    ...
    private String controller() {
        Files.readString(srcMainJava.resolve(
            "com/fractalx/admin/communication/CommunicationController.java"))
    }
}
