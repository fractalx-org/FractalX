 ...
 * in the com.fractalx.admin.observability package with the expected structure.
 */
class AdminObservabilityGeneratorSpec extends Specification {
    ...
    String basePackage = "com.fractalx.admin"
    ...
    private Path obsPkg() {
        srcMainJava.resolve("com/fractalx/admin/observability")
    }
    ...
    def "AlertSeverity defines INFO, WARNING, and CRITICAL enum values"() {
        ...
        c.contains("package com.fractalx.admin.observability")
        c.contains("INFO")
        c.contains("WARNING")
        c.contains("CRITICAL")
    }
