package com.fractalx.core.generator.resilience
...
class ResilienceConfigStepSpec extends Specification {
    ...
    private Path configFile() {
        serviceRoot.resolve("src/main/java/com/fractalx/generated/orderservice/NetScopeResilienceConfig.java")
    }
    ...
    def "NetScopeResilienceConfig.java is NOT created for a service without dependencies"() {
        ...
        !Files.exists(serviceRoot.resolve(
            "src/main/java/com/fractalx/generated/paymentservice/NetScopeResilienceConfig.java"))
    }
    ...
    def "config class is a @Configuration in the correct package"() {
        ...
        then:
        def c = javaContent()
        c.startsWith("package com.fractalx.generated.orderservice;")
