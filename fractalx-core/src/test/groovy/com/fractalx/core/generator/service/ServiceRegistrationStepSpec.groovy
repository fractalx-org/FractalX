...
class ServiceRegistrationStepSpec extends Specification {
    ...
    private Path generatedPkg() {
        serviceRoot.resolve("src/main/java/com/fractalx/generated/orderservice")
    }
    ...
    def "FractalRegistryClient is in the correct package"() {
        ...
        then:
        client().startsWith("package com.fractalx.generated.orderservice;")
    }
    ...
    def "step skips nothing for a service with no dependencies"() {
        ...
        Files.exists(serviceRoot.resolve(
            "src/main/java/com/fractalx/generated/simpleservice/FractalRegistryClient.java"))
    }
    ...
    def "hyphenated service names produce a valid Java package identifier"() {
        ...
        then:
        Files.exists(serviceRoot.resolve(
            "src/main/java/com/fractalx/generated/mycomplexservice/FractalRegistryClient.java"))
    }
}
