...
class NetScopeRegistryBridgeStepSpec extends Specification {
    ...
    private Path bridgeFile(String servicePkg) {
        serviceRoot.resolve("src/main/java/com/fractalx/generated/${servicePkg}/NetScopeRegistryBridge.java")
    }
    ...
    def "bridge is in the correct generated package"() {
        ...
        then:
        content().startsWith("package com.fractalx.generated.orderservice;")
    }
