...
class RegistryModelGeneratorSpec extends Specification {
    ...
    private Path modelFile() {
        srcMainJava.resolve("com/fractalx/registry/model/ServiceRegistration.java")
    }
    ...
    def "model is in the com.fractalx.registry.model package"() {
        when:
        generator.generate(srcMainJava)

        then:
        content().startsWith("package com.fractalx.registry.model;")
    }
