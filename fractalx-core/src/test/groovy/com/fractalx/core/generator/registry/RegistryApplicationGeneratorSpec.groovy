...
class RegistryApplicationGeneratorSpec extends Specification {
    ...
    private Path appFile() {
        srcMainJava.resolve("com/fractalx/registry/FractalRegistryApplication.java")
    }
    ...
    def "application class is in the com.fractalx.registry package"() {
        when:
        generator.generate(srcMainJava)

        then:
        appContent().startsWith("package com.fractalx.registry;")
    }
