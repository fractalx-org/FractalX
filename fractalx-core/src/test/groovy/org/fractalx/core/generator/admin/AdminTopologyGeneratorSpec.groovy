...
class AdminTopologyGeneratorSpec extends Specification {
    ...
    private static final String BASE_PKG = "org.fractalx.admin"

    private Path topologyPkg() {
        srcMainJava.resolve("org/fractalx/admin/topology")
    }
    ...
    def "TopologyGraph defines ServiceNode and ServiceEdge record types"() {
        ...
        then:
        def c = topologyGraph()
        c.startsWith("package org.fractalx.admin.topology;")
