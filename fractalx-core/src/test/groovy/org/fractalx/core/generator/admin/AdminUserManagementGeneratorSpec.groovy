...
class AdminUserManagementGeneratorSpec extends Specification {
    ...
    def "generates five files in the user package"() {
        ...
        def pkg = srcMainJava.resolve("org/fractalx/admin/user")
    ...
    def "AdminUser is in org.fractalx.admin.user package"() {
        when:
        generator.generate(srcMainJava, BASE)

        then:
        adminUser().contains("package org.fractalx.admin.user")
    }
    ...
    // helpers
    private String adminUser()      { Files.readString(srcMainJava.resolve("org/fractalx/admin/user/AdminUser.java")) }
    private String userStore()      { Files.readString(srcMainJava.resolve("org/fractalx/admin/user/UserStore.java")) }
    private String adminSettings()  { Files.readString(srcMainJava.resolve("org/fractalx/admin/user/AdminSettings.java")) }
    private String settingsStore()  { Files.readString(srcMainJava.resolve("org/fractalx/admin/user/SettingsStore.java")) }
    private String userController() { Files.readString(srcMainJava.resolve("org/fractalx/admin/user/UserController.java")) }
}
