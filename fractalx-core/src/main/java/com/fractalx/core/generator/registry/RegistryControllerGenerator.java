...
class RegistryControllerGenerator {
    ...
    void generate(Path srcMainJava) throws IOException {
        Path pkg = createPkg(srcMainJava, "com/fractalx/registry/controller");

        String content = """
                package com.fractalx.registry.controller;

                import com.fractalx.registry.model.ServiceRegistration;
                import com.fractalx.registry.service.RegistryService;
